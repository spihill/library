...
# :warning: メンバ変数を2つ持つ比較可能なクラス (VSCode スニペット)

<a href="../../index.html">Back to top page</a>

* category: <a href="../../index.html#54de4c5e0ecfc39083b31b56ee36cb19">snippet</a>
* <a href="{{ site.github.repository_url }}/blob/master/snippet/class2.cpp">View this file on GitHub</a>
...
{% raw %}
```cpp
// @title メンバ変数を2つ持つ比較可能なクラス (VSCode スニペット)
struct $1
{
	$2 $4;
	$3 $5;
